...
const MADHUKAR: Project = {
    ...
    slides: [
        ...
        `${PROJECTS_PHOTO_FOLDER}/madhukar/2.jpg`,
...
const OFFICE: Project = {
    ...
    slides: [
        ...
        `${PROJECTS_PHOTO_FOLDER}/office/1.jpg`,
...
export const PROJECTS: Project[] = [MADHUKAR, SUVEER, KRISHNA, ALEX, GEETHA, OFFICE, TROPICAL, NARESH]