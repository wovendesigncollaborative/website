...
export class ContactUsComponent implements OnInit {
  public headline = `With a a multi-disciplinary team, and over 9 years of experience in the field,
  ...
  public secondHeadline = `We engage with our clients in 3 ways depending on requirements and constraints.`;
